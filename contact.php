...
<head>
	...
	<title>Dream Jobs - Contact Us</title>
	...
	<meta property="og:image:alt" content="Dream Jobs" />
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
									<h5>Address</h5>
									<address> Dhaka, Bangladesh<br /></address>
								</li>
								<li>
									<h5>Email</h5><a href="mailto: dreamjobs@gmail.com">dreamjobs@gmail.com</a>
								</li>
								<li>
